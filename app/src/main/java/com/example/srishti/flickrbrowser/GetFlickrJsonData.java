...
public class GetFlickrJsonData extends GetRawData {
    ...
    public boolean createAndUpdateUri(String searchCriteria, boolean matchAll) {
        ...
        //Automatically build the url in proper format
    ...
    public void processResult() {                           // Processing the RAW Data and assigning it to Photo Object

        if (getmDownloadStatus() != DownloadStatus.OK) {     // Download Unsuccessful, so Error Log
        ...
        try {
            ...
            for (int i = 0; i < itemsArray.length(); i++) {
                ...
                JSONObject jsonMedia = jsonPhoto.getJSONObject(FLICKR_MEDIA);   // Media is an object Itself
    ...
    public class DownloadJsonData extends DownloadRawData {
        ...
        protected void onPostExecute(String webData) {          // After Data is recorded
        ...
        protected String doInBackground(String... params) {
            String[] par = {mDestinationUri.toString()};// Download Raw Data
